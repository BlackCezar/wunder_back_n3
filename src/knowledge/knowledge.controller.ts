import { Controller, Get, Post, Body, UsePipes, ValidationPipe, Delete, Param, BadRequestException, UseInterceptors, UploadedFile, Query } from "@nestjs/common";
...
export class KnowledgeController {
  ...
  private readonly knowledgeFileDest: String = '/uploads/knowledge/';
  ...
  async createCategory(@AdminOnly() permission: any, @Body() data: createCategoryDto) {
  ...
  async updateCategory(@AdminOnly() permission: any, @Body() data: updateCategoryDto) {
  ...
  async getPost(@Param("id") id: string) {
    ...
    const neighbours = await this.service.getPostNeighbours(post.id, post.categoryID)
