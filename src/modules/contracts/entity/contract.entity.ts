...
import { ICustomerSettings, ICustomerSystemSettings } from "../../../common/interfaces/settings.interface";
...
export class ContractEntity implements IContract {
  ...
  @ApiPropertyOptional({type: [CustomerSystemSettingsEntity], title: 'Правила систем'})
