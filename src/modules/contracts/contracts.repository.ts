...
export class ContractsRepository {
    ...
    public async getCount(where: ContractsSearchDto): Promise<number> {
    ...
    public async createContract(
        ...
        if (data.contractService)
            payload.contractService = data.contractService;
