...
import { IsBoolean, IsCurrency, IsDate, IsNumber, IsString } from "class-validator";
...
export class invoiceDocument implements IInvoiceDocument {
    ...
    name: string;
    @ApiProperty({
        title: 'Тип документа', enum: InvoiceDocumentType
    })
    @IsString()
...
export class InvoiceEntity {
    ...
    @ApiProperty({ title: "Кэшированные настройки систем", type: [CustomerSystemSettingsEntity] })
