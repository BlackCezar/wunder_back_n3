...
import { RequirementsResult, Token } from "../../../payments/payments.types";
...
export class AlfabankService {
    ...
    async getRequirements(
        ...
        try {
            ...
            const result =
                await this.httpService.axiosRef.get<RequirementsResult>(
                    `${
                        this.host
                    }/partner/1.0.3/documents/requirements?${data.toString()}`,
                    config
                );
            return result.data;
        } catch (e) {
