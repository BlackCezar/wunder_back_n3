...
import { RatesFilters, RatesFiltersEntity } from "./entities/rates-filters.entity";
...
export class RatesController {
  ...
  public async getList(@Query("filters") filtersString: string): Promise<RatesResponse> {
