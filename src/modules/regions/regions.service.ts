...
import { RegionsUpdateDto, RegionUpdateDto } from "./dto/region-update.dto";
...
export class RegionsService {
    constructor(
        ...
        public regionRepository: RegionsRepository,
    ...
    public async createRegion(
        ...
        const regionSettings = await this.settingsRepository.createEmpty(
            region.id
        );
        ...
        const contacts = await this.regionRepository.createEmptyContact(
            region.id
        );
    ...
    private async updateRegionSettings(
        ...
        const updatedSettings = await this.prisma.settings.update({
            ...
            data: {
                ...
                personalAgree: settings.personalAgree,
                publicContract: settings.publicContract,
            },
        });
