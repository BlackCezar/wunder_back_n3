...
import { IsArray, IsBoolean, IsDate, IsDateString, IsNumber, IsObject, IsString } from "class-validator";
...
export class CustomerEntity implements ICustomer {
  ...
  @ApiProperty({title: 'Новый ли пользователь', default: false, description: 'Вспомогательное поле, не влияет на логику'})
  @IsBoolean()
  isNew: boolean;
